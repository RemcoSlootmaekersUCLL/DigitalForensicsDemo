  ...
  return (
    <div className="w-full flex flex-col items-center p-6 text-white">
      ...
      <p className="text-gray-300 max-w-xl text-center mb-6 font-semibold">
        In het logbestand staan meerdere IP-adressen. Interne IP-adressen worden
        niet gerouteerd over het publieke netwerk (openbare internet). Zoek met
        deze informatie welk IP-adres hier duidelijk niet thuishoort. Klik op
        het verdachte IP-adres.
      </p>
