...
const FILES = [
  { name: "systeem.log", owner: "root", modifiedBy: "root", created: "2025-12-10", modified: "2025-12-14", description: "Systeemlogboek van de server.", suspicious: false },
  { name: "fin_admin.xlsx", owner: "admin", modifiedBy: "admin", created: "2025-11-30", modified: "2025-12-13", description: "Financiële administratie.", suspicious: false },
  { name: "kernel32.dll", owner: "system", modifiedBy: "hacker42", created: "2025-12-01", modified: "2025-12-14", description: "Systeemkernelbestand. Laatst gewijzigd door onbekende gebruiker!", suspicious: true },
  { name: "backup_2025-12-01.zip", owner: "root", modifiedBy: "root", created: "2025-12-01", modified: "2025-12-01", description: "Volledige systeembackup.", suspicious: false },
  { name: "invoice_2025.pdf", owner: "admin", modifiedBy: "admin", created: "2025-12-12", modified: "2025-12-12", description: "Factuur voor klant.", suspicious: false },
  { name: "malware.exe", owner: "unknown", modifiedBy: "unknown", created: "2025-12-14", modified: "2025-12-14", description: "Verdacht uitvoerbaar bestand.", suspicious: true },
  { name: "readme.txt", owner: "user", modifiedBy: "user", created: "2025-12-10", modified: "2025-12-10", description: "Gebruikersnotities.", suspicious: false },
  { name: "config.sys", owner: "system", modifiedBy: "system", created: "2025-12-01", modified: "2025-12-14", description: "Systeemconfiguratiebestand.", suspicious: false },
];
...
export default function RecoveryPuzzle() {
  ...
  const [connections, setConnections] = useState<(string | null)[]>([null, null, null]);
  ...
  const handleRecover = () => {
    setError("");
    const correct = FILES.map((f, i) => f.suspicious ? i : null).filter(i => i !== null);
    if (
  ...
  const handleCheck = () => {
    ...
    if (connections.every((val, idx) => val === SOLUTION[idx])) {
      ...
      setNetError("Niet alle kabels zijn correct aangesloten! Gebruik de hints.");
    }
  };
        ...
        <div className="text-white text-center p-10">
          ...
          {step === 0 && (
            <div className="mb-10">
              ...
              <p className="text-gray-300 mb-4">
                De server is gecrasht door corrupte of verdachte bestanden.<br />
                Selecteer alle verdachte/corrupte bestanden in de lijst hieronder en klik op <span className="text-green-300 font-semibold">Herstel</span> om het systeem te repareren.
              </p>
              <div className="max-w-2xl mx-auto bg-gray-800/70 rounded-xl p-6 shadow-lg mb-4">
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {FILES.map((file, idx) => (
                      <tr key={file.name} className={selected.includes(idx) ? "bg-yellow-900/40" : ""}>
          ...
          {step === 1 && (
            <div className="mb-10">
              ...
              <p className="text-gray-300 mb-4">
                De netwerkverbindingen zijn losgekoppeld!<br />
              ...
              <div className="max-w-lg mx-auto bg-gray-800/70 rounded-xl p-6 shadow-lg mb-4">
                <table className="w-full text-sm mb-4">
                  ...
                  <tbody>
                    {CABLES.map((cable, idx) => (
                      <tr key={cable.id}>
                        <td className="py-2 font-semibold" style={{ color: cable.color }}>{cable.label}</td>
                        <td>
                          <select
                ...
                {netError && <div className="text-red-400 mb-2">{netError}</div>}
                <button
          ...
          {step === 2 && (
            <div className="mb-10">
              ...
              <p className="text-gray-300 mb-4">
                Het beheerderswachtwoord is gecodeerd.<br />
                Decodeer de volgende string en vul het wachtwoord in:<br />
                <span className="text-green-300 font-mono">cm9iZXJ0MTIzZy1yb3V0</span>
              </p>
          ...
          {step === 3 && (
            <div className="fixed inset-0 flex items-center justify-center bg-black/80 z-50">
              <div className="bg-gray-900 rounded-xl p-10 shadow-2xl text-center max-w-lg mx-auto">
                <h2 className="text-3xl font-bold text-green-400 mb-4">Systeem Volledig Hersteld!</h2>
                <p className="text-lg text-gray-200 mb-6">Alle recovery taken zijn succesvol afgerond.<br />
                <span className="text-green-300">Gefeliciteerd, je hebt het systeem volledig hersteld!</span></p>
