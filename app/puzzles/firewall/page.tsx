...
export default function FirewallPuzzlePage() {
  ...
  const [choices, setChoices] = useState<Record<number, "ALLOW" | "BLOCK" | null>>({});
  const [completed, setCompleted] = useState(false);
  const [error, setError] = useState("");

  const connections: Connection[] = [
    { id: 1, direction: "OUTBOUND", from: "172.16.1.24", to: "1.1.1.1:443", protocol: "HTTPS", correct: "ALLOW" },
    { id: 2, direction: "INBOUND", from: "66.23.91.4", to: "172.16.1.24:80", protocol: "HTTP", correct: "ALLOW" },
    { id: 3, direction: "INBOUND", from: "203.44.12.7", to: "172.16.1.24:22", protocol: "SSH", correct: "BLOCK" },
    { id: 4, direction: "INBOUND", from: "39.117.8.22", to: "172.16.1.24:993", protocol: "IMAP", correct: "ALLOW" },
  ];
      ...
      {completed && (
        <>
          <div className="mt-6 bg-green-700 px-6 py-3 rounded shadow text-lg text-center">
            ✅ Firewall Config OK<br />
            Je hebt alle verbindingen correct beoordeeld!<br />
